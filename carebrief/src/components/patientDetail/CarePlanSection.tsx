...
export const CarePlanSection: React.FC<CarePlanSectionProps> = ({
  plan,
  onToggleGoal,
  onEditGoal,
  onDeleteGoal,
  ...
  const planRemoteId = React.useMemo(() => plan.uuid ?? undefined, [plan]);
    ...
    <div className="space-y-4">
      <div
        ...
        style={{
          ...
          border: `1px solid ${colors.primaryMuted}40`,
        }}
      >
        <p
        ...
        <div className="flex items-center gap-3">
          <div
            ...
            style={{ backgroundColor: colors.primaryMuted + "40" }}
          >
            <div
          ...
          <span
            ...
            onKeyDown={(e) => {
              if (e.key === "Enter") handleMarkPlanDone();
            }}
          ...
          >
            {markingDone
              ? "送信中…"
              : `${completedGoals.length}/${totalGoals} 完了`}
          </span>
        </div>
      </div>
      ...
      {showAddForm ? (
        ...
        <button
          ...
          className="w-full py-3 rounded-xl flex items-center justify-center gap-2 text-sm font-medium transition-colors hover:opacity-80"
          style={{
